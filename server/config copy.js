...
const settings = {
  ...
  categoryPlace: [
    {
      id: "CategoryPlace",
      titleHero: "Explore Trusted <span>###</span> Services in <span>##</span>",
      subtitleHero:
        "Find top-rated ### professionals serving the ## area - verified, reviewed, and ready to help.",
      seoTitle: "Top ### Services in ##, Verified Local Experts",
      seoDesc:
        "Discover trusted ### services in ##. Browse verified providers offering quality help for your local needs.",
    },
    {
  ...
  footer: {
    ...
    addresCompany: "48A Boundary Road, London NW8 0HJ",
