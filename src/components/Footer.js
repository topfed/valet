        ...
        <div className="container cont-space d-flex gap-6 f-f-d">
          <div className="f-w-100 mb-3">
            ...
            <div className="d-flex items-center mb-2 gap-3 pl-1">
              ...
              <p className="m-0 text-16">{footerOptions?.addresCompany}</p>
            </div>
            <div className="d-flex items-center mb-2 gap-2">
              ...
              >
                <p className="m-0 text-16">{footerOptions?.phoneNumber}</p>
              </a>
            </div>
            <div className="d-flex items-center mb-5 gap-3">
              <Svg name="emailf" width="24px" />
              <p className="m-0 text-16">{footerOptions?.emailData}</p>
            </div>
        ...
        <div className="w-100">
          ...
          <div className="mt-3 w-100">
            <div className="w-100">
              ...
              <div
                className="d-grid grid-3-1 gap-3 products h-compare-s p-3 overflow-scrollY"
                id="searchResults"
              ></div>
            </div>
          </div>
